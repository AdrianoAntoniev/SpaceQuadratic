...
import edu.tcc.actions.SceneActions;
import edu.tcc.actions.SceneSegment;
import edu.tcc.actors.BaseActor;
import edu.tcc.actors.DialogBox;
import edu.tcc.actors.Scene;
...
public class StoryScreen extends BaseScreen {
	...
	public void initialize() {
		...
		background.loadTexture("actors/oceanside.png");
		background.setSize(800, 600);
		background.setOpacity(0);
		BaseActor.setWorldBounds(background);

		BaseActor turtle = new BaseActor(0, 0, mainStage);
		turtle.loadTexture("actors/turtle-big.png");
		...
		continueKey.loadTexture("keys/key-C.png");
